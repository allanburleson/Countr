...
class LKEditItemPropertiesViewController: UITableViewController, UITextFieldDelegate {
    ...
    override func loadView() {
        ...
        let textFieldFont = UIFont.systemFontOfSize(16)
    ...
    func showNotificationForError(error: LKAddCountdownError) {
        ...
        case .DateIsPast:
            let alertTitle = NSLocalizedString("me.kollmer.countr.addItem.dateInPastAlert.title", comment: "")
            let alertMessage = NSLocalizedString("me.kollmer.countr.addItem.dateInPastAlert.message", comment: "")
